...
class BeneficiarioMemorial(models.Model):
    memorial = models.ForeignKey(MemorialDeCalculo, on_delete=models.CASCADE, related_name="beneficiarios")
    nome = models.CharField(max_length=255)
    cpf = models.CharField(max_length=14)
    cota = models.DecimalField(max_digits=5, decimal_places=2)
    agencia_cc = models.CharField(max_length=20)
    ir = models.DecimalField(max_digits=10, decimal_places=2)
    contribuicao_previdencia = models.DecimalField(max_digits=10, decimal_places=2)
    cpm = models.DecimalField(max_digits=10, decimal_places=2)
    auxilio_liquido = models.DecimalField(max_digits=10, decimal_places=2)
